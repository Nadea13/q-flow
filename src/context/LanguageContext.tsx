...
export const translations = {
  th: {
    ...
    addManualBookingBtn: '+ ลงคิวเอง (โทรจอง/หน้าร้าน)',
    manualBookingTitle: 'ลงคิวจองด้วยตนเอง (โทรจอง / Walk-in)',
    ...
    // Services & Branches Tab
    branchInfoTitle: 'ข้อมูลสาขาและที่ตั้ง',
    branchName: 'ชื่อสาขา',
    branchAddress: 'ที่อยู่ / พิกัดร้าน',
  ...
  en: {
    ...
    startFree60s: 'Get Started Free in 60s',
    ...
    demoShopBook: 'Demo Shop: Glam Studio (Booking UI)',
    demoShopDashboard: 'Demo Shop: Glam Studio (Dashboard)',
    uvp1Title: 'Smart Queue, Seamless Flow',
    ...
    shopNameLabel: '1. Shop / Service Name',
    shopNamePlaceholder: 'e.g. Glam Studio, Barber X',
    promptpayLabel: '2. PromptPay Phone or National ID Number',
    ...
    createShopBtn: 'Launch Booking System (Free)',
