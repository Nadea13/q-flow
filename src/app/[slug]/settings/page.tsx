          ...
          <form onSubmit={handleVerifyPin} className="space-y-4">
            <div>
              <input
                ...
                className="w-full text-center tracking-[1em] text-2xl font-bold py-3 bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white"
              />
            ...
            <button
              ...
              className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white rounded-xl text-xs font-bold transition active:scale-98 shadow-2xs"
            >
              {verifyingPin ? 'กำลังตรวจสอบ...' : 'เข้าสู่ระบบ'}
            </button>
          </form>
        </div>
      </div>
