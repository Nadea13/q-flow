...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans antialiased selection:bg-indigo-500 selection:text-white transition-colors">
      ...
      <section className="py-16 px-4 sm:px-6 max-w-5xl mx-auto">
        <div className="rounded-3xl bg-gradient-to-tr from-indigo-600 to-indigo-800 dark:from-indigo-900 dark:to-slate-900 p-8 sm:p-12 text-center text-white shadow-xl shadow-indigo-600/10 relative overflow-hidden border border-indigo-500/30">
          ...
          <p className="text-xs sm:text-sm text-indigo-100 max-w-xl mx-auto mb-8 leading-relaxed font-normal">
            {lang === 'th'
              ? 'เปิดร้านและรับลิงก์จองคิวพร้อมระบบตรวจสลิปอัตโนมัติ ไม่ต้องผูกบัตรเครดิต'
      ...
      {/* FOOTER */}
      <footer className="border-t border-slate-200/80 dark:border-slate-850/80 bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 font-sans">
        {/* Main Footer Content */}
            ...
            <div className="md:col-span-5 space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200/80 dark:border-indigo-800/80 text-[11px] font-semibold text-indigo-700 dark:text-indigo-400">
                  <ShieldCheck className="w-3.5 h-3.5" />
                  <span>SSL & PromptPay Secured</span>
                </div>
              </div>
            </div>
                ...
                <ul className="space-y-2 text-xs">
                  ...
                  <li>
                    <Link href="/pricing" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">
                      {lang === 'th' ? 'ติดต่อแอดมิน' : 'Contact Us'}
                    </Link>
                  </li>
                </ul>
              </div>
